...
| L6 bridge örnek | `examples/engine_ilk_oyun.tpr` (kod, 94 satır), **`engine_arena.tpr` + `assets/arena.sahne`** (editör sahnesi → derlenmiş blob → Tulpar oyunu, 209 satır), **`engine_aksiyon.tpr` "Gölge Salonları"** (Faz 7 dikey dilimi: iki bölüm, düşman durum makinesi, menü/duraklat/ayarlar, 1097 satır; 2026-09-21'den beri `enum` + çoklu dönüş kullanıyor, sihirli sayı ve yön globalleri yok) | ✅ |
